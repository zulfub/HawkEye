...
from img_proc import Preprocess
from img_proc import DetectChars
from img_proc import PossiblePlate
from img_proc import PossibleChar
...
def detectPlatesInScene(imgOriginalScene):
    ...
    if ProcessImg.showSteps == True: # show steps #######################################################
    ...
    if ProcessImg.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, ProcessImg.Main.SCALAR_WHITE)
    ...
    if ProcessImg.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), ProcessImg.Main.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), ProcessImg.Main.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), ProcessImg.Main.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), ProcessImg.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if ProcessImg.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, ProcessImg.Main.SCALAR_WHITE)
        # end if # show steps #####################################################################
